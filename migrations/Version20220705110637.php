 ...
 */
final class Version20220705110637 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment AS SELECT id, user_id, body, created_on FROM comment');
        $this->addSql('DROP TABLE comment');
        $this->addSql('CREATE TABLE comment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, body VARCHAR(255) NOT NULL, created_on DATETIME NOT NULL)');
        $this->addSql('INSERT INTO comment (id, user_id, body, created_on) SELECT id, user_id, body, created_on FROM __temp__comment');
        $this->addSql('DROP TABLE __temp__comment');
        $this->addSql('CREATE INDEX IDX_9474526CA76ED395 ON comment (user_id)');
    }
