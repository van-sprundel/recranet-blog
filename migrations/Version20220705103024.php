 ...
 */
final class Version20220705103024 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE test (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, items CLOB NOT NULL COLLATE BINARY --(DC2Type:array)
        )');
